...
def runmymodel2():
    ...
    nfeats_val = pd.read_csv(input_path + 'single_cell_graphs_distances/' + 'nfeats_test_B_scaled_v4.csv')
   
    db_val_clinZ = pd.read_csv(input_path + 'external_val_Zurich_clin.csv')
    nfeats_valZ = pd.read_csv(input_path + 'single_cell_graphs_distances/' + 'nfeats_test_Z_scaled_v4.csv')

    db_val_clinMB = pd.read_csv(input_path + 'val_metabric_clin.csv')
    nfeats_valMB = pd.read_csv(input_path + 'single_cell_graphs_distances/' + 'nfeats_test_internal_scaled_v4.csv')
